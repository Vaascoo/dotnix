...

{
  dconf.settings = {
    ...
    "org/gnome/evince/default" = {
      ...
      sidebar-size = 132;
      sizing-mode = "free";
      window-ratio = mkTuple [ 1.4814814814814814 1.3876262626262625 ];
      zoom = 0.8521528122183413;
    };
    ...
    "org/gnome/software" = {
      check-timestamp = mkInt64 1756304075;
      first-run = false;
      flatpak-purge-timestamp = mkInt64 1756424613;
    };
